...
class ExpressionParserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPropertyAccessExpression()
    {
        try {
           ...
           $this->AssertEquals($expr->getType() instanceof OString, true);
    ...
    public function testRelationalExpression()
    {
        try {
            ...
            $this->AssertEquals($paramExpression[0]->getType() instanceof OString, true);
            $this->AssertEquals($paramExpression[1]->getType() instanceof OString, true);
            $this->AssertEquals($expr->getRight() instanceof ConstantExpression, true);
